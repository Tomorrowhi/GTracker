package com.bct.gpstracker.fix.swipemenu;
...
public class SwipeMenuAdapter implements WrapperListAdapter,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SwipeMenuListView.ViewProcessor viewProcessor=swipeMenuListView.getViewProcessor();
        if(viewProcessor!=null) {
            viewProcessor.execute(layout,position);
        }
        return layout;
    }
