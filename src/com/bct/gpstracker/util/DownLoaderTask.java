...
public class DownLoaderTask extends AsyncTask<Void, Integer, Long> {
    ...
    public DownLoaderTask(String url, String out, String unZIP, Context context,int version) {
        super();
        if (context != null) {
...
//        ((MainActivity) mContext).showUnzipDialog();
        //解压文件
        ZipExtractorTask unZipTask = new ZipExtractorTask(outPath, unZIPPath, mContext, true,version);
        unZipTask.execute();
