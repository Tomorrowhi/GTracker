package com.bct.gpstracker.adapter;
...
public class BaseArrayListAdapter extends BaseAdapter {
	...
	protected boolean mOldOrNewGif;
	...
	public BaseArrayListAdapter(Context context, List<String> datas,boolean oldOrNew) {
		mContext = context;
		mInflater = LayoutInflater.from(context);
        mOldOrNewGif=oldOrNew;
		if (datas != null && datas.size() > 0) {
			mDatas = datas;
		}
	}
