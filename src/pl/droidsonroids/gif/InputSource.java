...
public abstract class InputSource {
    ...
    abstract pl.droidsonroids.gif.GifInfoHandle open() throws IOException;
    ...
    public static final class DirectByteBufferSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws GifIOException {
            return pl.droidsonroids.gif.GifInfoHandle.openDirectByteBuffer(byteBuffer, false);
        }
    }
    ...
    public static final class ByteArraySource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws GifIOException {
            return pl.droidsonroids.gif.GifInfoHandle.openByteArray(bytes, false);
        }
    }
    ...
    public static final class FileSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws GifIOException {
            return pl.droidsonroids.gif.GifInfoHandle.openFile(mPath, false);
        }
    }
    ...
    public static final class UriSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws IOException {
            return pl.droidsonroids.gif.GifInfoHandle.openUri(mContentResolver, mUri, false);
        }
    }
    ...
    public static final class AssetSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws IOException {
            return pl.droidsonroids.gif.GifInfoHandle.openAssetFileDescriptor(mAssetManager.openFd(mAssetName), false);
        }
    }
    ...
    public static final class FileDescriptorSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws IOException {
            return pl.droidsonroids.gif.GifInfoHandle.openFd(mFd, 0, false);
        }
    }
    ...
    public static final class InputStreamSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws IOException {
            return pl.droidsonroids.gif.GifInfoHandle.openMarkableInputStream(inputStream, false);
        }
    }
    ...
    public static class ResourcesSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws IOException {
            return pl.droidsonroids.gif.GifInfoHandle.openAssetFileDescriptor(mResources.openRawResourceFd(mResourceId), false);
        }
    }
    ...
    public static class AssetFileDescriptorSource extends InputSource {
        ...
        @Override
        pl.droidsonroids.gif.GifInfoHandle open() throws IOException {
            return pl.droidsonroids.gif.GifInfoHandle.openAssetFileDescriptor(mAssetFileDescriptor, false);
        }
    }
