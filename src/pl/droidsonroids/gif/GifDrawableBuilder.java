...
public class GifDrawableBuilder {
    ...
    private pl.droidsonroids.gif.GifDrawable mOldDrawable;
     ...
     */
    public pl.droidsonroids.gif.GifDrawable build() throws IOException {
     ...
     */
    public GifDrawableBuilder with(pl.droidsonroids.gif.GifDrawable drawable) {
     ...
     * {@link pl.droidsonroids.gif.GifDrawable#isVisible()} for more information about drawable visibility.
