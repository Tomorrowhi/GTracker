...
public class GifDrawable extends Drawable implements Animatable, MediaPlayerControl {
    ...
    final pl.droidsonroids.gif.GifInfoHandle mNativeInfoHandle;
    final ConcurrentLinkedQueue<pl.droidsonroids.gif.AnimationListener> mListeners = new ConcurrentLinkedQueue<>();
    ...
    public GifDrawable(@NonNull String filePath) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openFile(filePath, false), null, null, true);
    }
    ...
    public GifDrawable(@NonNull File file) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openFile(file.getPath(), false), null, null, true);
    }
    ...
    public GifDrawable(@NonNull InputStream stream) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openMarkableInputStream(stream, false), null, null, true);
    }
    ...
    public GifDrawable(@NonNull AssetFileDescriptor afd) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openAssetFileDescriptor(afd, false), null, null, true);
    }
    ...
    public GifDrawable(@NonNull FileDescriptor fd) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openFd(fd, 0, false), null, null, true);
    }
    ...
    public GifDrawable(@NonNull byte[] bytes) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openByteArray(bytes, false), null, null, true);
    }
    ...
    public GifDrawable(@NonNull ByteBuffer buffer) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openDirectByteBuffer(buffer, false), null, null, true);
    }
    ...
    public GifDrawable(@Nullable ContentResolver resolver, @NonNull Uri uri) throws IOException {
        this(pl.droidsonroids.gif.GifInfoHandle.openUri(resolver, uri, false), null, null, true);
    }

    GifDrawable(pl.droidsonroids.gif.GifInfoHandle gifInfoHandle, final GifDrawable oldDrawable, ScheduledThreadPoolExecutor executor, boolean isRenderingTriggeredOnDraw) {
        mIsRenderingTriggeredOnDraw = isRenderingTriggeredOnDraw;
        mExecutor = executor != null ? executor : pl.droidsonroids.gif.GifRenderingExecutor.getInstance();
     ...
     */
    public void reset() {
        mExecutor.execute(new pl.droidsonroids.gif.SafeRunnable(this) {
            @Override
            public void doWork() {
    ...
    public pl.droidsonroids.gif.GifError getError() {
        return pl.droidsonroids.gif.GifError.fromCode(mNativeInfoHandle.getNativeErrorCode());
    }
     ...
     */
    public void addAnimationListener(@NonNull pl.droidsonroids.gif.AnimationListener listener) {
     ...
     */
    public boolean removeAnimationListener(pl.droidsonroids.gif.AnimationListener listener) {
